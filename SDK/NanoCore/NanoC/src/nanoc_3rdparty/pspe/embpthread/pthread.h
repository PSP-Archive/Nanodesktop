 ...
 */
#ifndef EMB_PTHREAD_H 
#define EMB_PTHREAD_H

#if (defined PSPE_PLATFORM)
       #include <nanoc_3rdparty/pspe/embpthread/platform/nd_PSPE_PSP/pte_types.h>
#elif (defined PSP_PLATFORM) 
       #include <nanoc_3rdparty/psp/embpthread/platform/nd_PSPE_PSP/pte_types.h>
#endif
...
#ifdef _INCLUDE_SETJMP_IN_PTHREAD_H_
       #include <setjmp.h>        // Inibito per evitare problemi su sched.h
#endif
