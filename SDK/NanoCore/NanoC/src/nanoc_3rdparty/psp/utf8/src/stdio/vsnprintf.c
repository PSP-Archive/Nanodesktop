...
#include <nanoc_3rdparty/psp/utf8/include/utf8/nd_stdio.h>

#include <nanoc_3rdparty/psp/utf8/include/utf8/limits.h>
#include <nanoc_3rdparty/psp/utf8/include/utf8/nd_stdlib.h>
#include <errno.h>
#include <string.h>
#include <stdarg.h>
...
int utf8_snprintf (char* s, size_t maxlen, const char* format, ...)
{
  va_list args;
  int result;

  va_start(args,format);
  result = utf8_vsnprintf(s,maxlen,format,args);
  va_end(args);
  return result;
}


int utf8_vsnprintf (char* s, size_t maxlen, const char* format, va_list args)
{
  directives d;
  arguments a;
