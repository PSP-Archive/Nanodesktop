...
#if ( defined (PSPE_PLATFORM) || defined (PSP_PLATFORM) )         // Codice hackerato per nd
...
#else         // Codice standard  (normalmente non compilato)
...
#endif   // if ( defined (PSPE_PLATFORM) || defined (PSP_PLATFORM) )  
