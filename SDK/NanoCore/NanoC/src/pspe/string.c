/*
   ...
   ----------------------------------------------------------------------------
   Routines di base per manipolazione stringhe
   ----------------------------------------------------------------------------
*/   
...
int stricmp (unsigned char *scan1, unsigned char *scan2)
{
    unsigned char c1, c2;
...
int strnicmp (unsigned char *str1, unsigned char *str2, int len)
{
    unsigned char c1,c2;
