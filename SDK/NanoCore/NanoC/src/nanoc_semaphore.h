/*
   ---------------------------------------------------------------------------------
   nanoc_semaphore.h               NanoC File Headers (PSP/PSPE)
   ---------------------------------------------------------------------------------
...
#ifndef _NANOC_SEMAPHORE_H
        #define _NANOC_SEMAPHORE_H
               
        #ifdef PSPE_PLATFORM
                #include <nanoc_3rdparty/pspe/embpthread/semaphore.h>        
        #endif
         
        #ifdef PSP_PLATFORM
                #include <nanoc_3rdparty/psp/embpthread/semaphore.h>
        #endif


#endif	// _NANOC_SEMAPHORE_H
