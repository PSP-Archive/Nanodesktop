/*
   ---------------------------------------------------------------------------------
   nanoc_sched.h               NanoC File Headers (PSP/PSPE)
   ---------------------------------------------------------------------------------
...
#ifndef _NANOC_SYS_SCHED_H
        #define _NANOC_SYS_SCHED_H
               
        #ifdef PSPE_PLATFORM
                #include <nanoc_3rdparty/pspe/embpthread/sched.h>        
        #endif
         
        #ifdef PSP_PLATFORM
                #include <nanoc_3rdparty/psp/embpthread/sched.h>
        #endif


#endif	// _NANOC_SYS_SCHED_H
