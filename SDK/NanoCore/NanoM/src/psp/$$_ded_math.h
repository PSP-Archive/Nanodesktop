/*
   --------------------------------------------------------------------------
   $$_ded_math.h               NanoC File Headers (PSP)
   --------------------------------------------------------------------------
...
*/   
        ...
        // Questa sezione riproduce la normale struttura di math.h
        ...
        // Questa sezione richiama l'headers per le funzioni VFPU della PSP: si noti
        // che NanoM si limita a fornire delle routines vfpu. E' compito dell'HAL
        // di Nanodesktop eseguire l'astrazione di queste routines, emulando il
        // comportamento dell'acceleratore matematico quando questo non è 
        // disponibile su una data piattaforma. Per tale ragione, il macro wrapper
        // che mappa le funzioni matematiche sulla libm standard o sulla VFPU è
        // contenuto dentro HAL Prototypes e non qui. 
        
        // LibMath 
        
                #include <psp/vfpu/pspmath.h>
         
        // Prototipi interfaccia EMI 
                
                #include <psp/emi/emi.h>
