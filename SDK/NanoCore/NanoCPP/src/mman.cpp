...
#ifndef _MSC_VER
    #if ((!defined _RWSTD_NO_MMAP) || (!defined _RWSTD_NO_MUNMAP))
    #  include <sys/mman.h>
    #endif   // if ((!defined _RWSTD_NO_MMAP) || (!defined _RWSTD_NO_MUNMAP))
#else
#  include <windows.h>
#  include <io.h>
#endif   // _MSC_VER
...
#  define MAP_FAILED (void*)-1
    ...
    // FIXME: add support for memory mapped files (or emulate it)
    void* const data = 0;
