...
int INFINITY_main ()
{
    ...
    cfgprintf ("// computed infinities and NANs for a %s endian architecture\n",
...
#  endif   // _RWSTD_NO_LONG_DOUBLE
    ...
    cfgprintf ("// IEEE 754 infinities and NANs for a %s endian architecture\n"
    ...
    cfgprintf ("#define _RWSTD_FLT_HAS_DENORM  %d\n", flt_has_denorm);
    ...
    cfgprintf ("#define _RWSTD_DBL_HAS_DENORM  %d\n", dbl_has_denorm);
    ...
    cfgprintf ("#define _RWSTD_LDBL_HAS_DENORM  %d\n", ldbl_has_denorm);
