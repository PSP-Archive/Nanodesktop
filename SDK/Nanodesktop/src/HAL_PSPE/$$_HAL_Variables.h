/*  
    ...
    ---------------------------------------------------------------------------
    FILE SPECIALE DI DEFINIZIONE DELLE VARIABILI PER HAL (PSPE)
    ---------------------------------------------------------------------------
      ...
      // Impedirà che questo file possa essere incluso due volte nella compilazione
       ...
       #define NDEXTERN extern
                                ...
                                */
                                ...
                                #define __MOUSE_DELAY 0.011307168000444091284651041774023/3
                                #define __DELAY_SCALE 17687894.97
                                ...
                                */
                                ...
                                /* 
                                   ------------------------------------------------------------------------------------
                                   STRUTTURE DATI PER L'EMULAZIONE DEL MOUSE
                                   ------------------------------------------------------------------------------------
                                */
                                ...
                                */
                                ...
                                /*
                                  ...
                                  ----------------------------------------------------------
                                  Nanodesktop per PSP/PSPE non supporta le webcam, che 
                                  restano riservate alla versione KSU della libreria. 
                                  
                                  Tuttavia, è necessario comunque mantenere dei simboli per
                                ...
                                */
                                ...
                                #ifdef HAL_I_NEED_TO_DECLARE_VARIABLES   
                                    int ndStdNetworkTimeOut = 200000;
                                #else
                                ...
                                */
                                ...
                                // Condizioni evento speciali
                                
                                #define SND_EVENT_IDLE       0x8000000
