    ...
    switch (Code)
    {
           ...
           case NDGET_OPERATINGSYSTEM:
           {
                ...
                */
                ...
                strcpy (Param1, "PSPE PseudoKernel");
                return 0;
           }
           ...
           case NDGET_CPUFREQUENCY:
           {
                return 333;        // Restituisce la frequenza in Mhz del processore.
                                   // Nel caso di PSPE il risultato è solo convenzionale.
           }
           ...
           case NDGET_PSPFIRMWAREVERSION:      // Sotto emulatore PSPE la versione del firmware non è nota
           {
                return NDPSPFW_UNKNOWN;
           }
           
           case NDGET_EMULATEDFIRMWAREVERSION: // Risponde con un codice che emula la presenza di un fw 1.00
           {
                return NDPSPEMUFW100;
           }
