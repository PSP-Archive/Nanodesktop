/*  
    ...
    ---------------------------------------------------------------------------
    FUNZIONI PER GENERAZIONE SEGNALI RAWIR (PSPE)
    ---------------------------------------------------------------------------
...
/*
    ----------------------------------------------------------------------------
    Simboli per gestione RAWIR (PSPE)
    ----------------------------------------------------------------------------
*/
...

{
    ...
    char _Trasmission;
      ...
      {     
                    ...
                    // In questo punto, sotto PSPE, inseriamo una semplice routine di emulazione
                    // che simula il successo.
