/*  
    ...
    ----------------------------------------------------------------------------
    Network standard function (PSPE)
    ----------------------------------------------------------------------------
    ...
    N.B.
    La modalità PSPE non supporta, a differenza della modalità KSU, le
...
*/
{
    return _htonl (sceNetInetInetAddr (String));
...
*/ 
{
    ...
    address_in->sin_port        = _htons (Port);
    address_in->sin_addr.s_addr = _htonl (Address32);    
}
