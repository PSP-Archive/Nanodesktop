/*  
    ...
    ---------------------------------------------------------------------------
    API PER LA GESTIONE DI IRDA (PSPE)
    
    Si tenga presente che sotto PSPE, ovviamente, non è possibile inviare/ricevere segnali
    infrarossi, ma l'API viene ugualmente supportata a scopo di test delle utility
    (viene emulata la ricezione/invio delle informazioni). 
    ---------------------------------------------------------------------------
*/
...
*/
{
   ...
   for (Counter=0; Counter<Number; Counter++)
   {
      ...
      {        
         ...
         IOResult=1;         // EMULAZIONE: Sotto PSPE non è possibile ovviamente eseguire la trasmissione
                             // ma viene simulato il successo  
      }
      else                   
...
*/
{
   ...
   {        
            ...
            // EMULAZIONE: Non è possibile leggere da IRDA sotto PSPE, ma viene emulato il processo
            // di lettura
