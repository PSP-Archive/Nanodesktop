/*  
    ...
    ---------------------------------------------------------------------------
    FILE SPECIALE DI DEFINIZIONE DEI PROTOTIPI PER HAL (PSPE)
    ---------------------------------------------------------------------------
...
*/
      ...
      // Impedirà che questo file possa essere incluso due volte nella compilazione
                                ...
                                // ---------------------------------------------------------------
                                // Prototipi di routines del pseudo kernel di PSPE emulator
                                // ---------------------------------------------------------------
                                
                                 void pspDisplayWaitVblankStart();                                                 // Riferimenti alle routine del kernel di sistema
                                 void pspDisplaySetMode(long,long,long);                                           // per l'accesso al sottosistema grafico
                         ...
                         #ifdef HAL_I_NEED_TO_DEFINE_ALL_PROTOTYPES  
                                //static u32 INTERNAL_IR_SIGNAL (int Value, int NegLogic, int ticks); 
                                ...
                                #include <.\HAL_PSPE\$$_HAL_FpuWrapper.h>
                                ...
                                void ndHAL_InitHighLevelUSBApi();
                                ...
                                /// ----------------------------------------------------------
                                 ...
                                 #include <HAL_PSPE/$$_HAL_NetworkWrapper.h>
