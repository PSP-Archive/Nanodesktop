/*  
    ...
    GESTORE AUDIO (PSP)
    ----------------------------------------------------------------------------
    L'unica limitazione di questo componente in modalità PSP rispetto alla 
    modalità KSU PSP, è che l'oversampling viene eseguito a partire dalla
    frequenza di 44100 Hz
    ----------------------------------------------------------------------------
*/          
...
*/
{
     ...
     pspAudioInit (); 
     // sceAudioSetFrequency (48000);      Impossibile sotto modalità PSP semplice
}
