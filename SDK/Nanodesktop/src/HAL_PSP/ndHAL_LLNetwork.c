/*  
    ...
    ---------------------------------------------------------------------------
    FUNZIONI DI GESTIONE DI RETE A BASSO LIVELLO (PSP)
    ---------------------------------------------------------------------------
 */
...
/*
     ...
     In realtà, in modalità PSP semplice essa non esegue alcuna funzione, posto
     che in modalità PSP le funzioni di rete non sono disponibili  
*/
{
     return;    
}
