/*  
    ...
    ---------------------------------------------------------------------------
    FILE SPECIALE: WRAPPER FUNZIONI FPU (PSP CFW mode)
    ---------------------------------------------------------------------------
...
*/
    ...
    /* 
        Sotto PSP (o PSP CFW), le funzioni matematiche e trigonometriche
...
/*
    ...
    ---------------------------------------------------------------------------
     Sotto PSP/PSP CFW le funzioni ndHAL_XFPU per la gestione delle matrici
