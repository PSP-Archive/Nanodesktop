...
*/
{
     ...
     {
        KRNEXT_PRX_pspAudioInit ();
        //KRNEXT_PRX_sceAudioSetFrequency (48000);
     }
}
...
/*
    ...
    Sono previsti i seguenti codici di errore:
         ...
         ERR_DISABLED_FOR_TROUBLES_IN_KRNEXTENDER  Supporto audio disabilitato per problemi con il kernel extender
*/
{
    ...
    {  
      ...
      return ERR_DISABLED_FOR_TROUBLES_IN_KRNEXTENDER; 
}
...
int ndHAL_SND_WriteToChannel (int NrChannel, void *samples, int NrSamples, float AmpFactor)
{
    ...
    {          
            if (ndAudioDescriptor [NrChannel].IsActive)
            {
                    ...
                    OverSamples = 44100.0/(float)(ndAudioDescriptor [NrChannel].VFreq);
