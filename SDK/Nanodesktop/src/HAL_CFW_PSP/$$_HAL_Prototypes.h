/*  
    ...
    ---------------------------------------------------------------------------
    FILE SPECIALE DI DEFINIZIONE DEI PROTOTIPI PER HAL (PSP CFW mode)
    ---------------------------------------------------------------------------
...
*/
      ...
      // Impedirà che questo file possa essere incluso due volte nella compilazione
                                ...
                                extern void ndHAL_CFW_InhibitCFWLoop (void);
                                extern void ndHAL_CFW_DeInhibitCFWLoop (void);
                                
                                extern void ndHAL_CFW_InitLoopServices (void);
                                extern void ndHAL_CFW_ExecuteLoopServices (void);
                                extern void ndHAL_CFW_BootManager (void);
                                extern void ndHAL_CFW_BootScreen (void);
                                
                                #define CFWMain(xA)        UserMain(SceSize args, void *argp)          
                                ...
                                #include <.\HAL_CFW_PSP\$$_HAL_FpuWrapper.h>
                                ...
                                /// ---------------------------------------------------------
                                     ...
                                     extern char INTERNAL_GOCAM_GenerateHwResolutionCodes (int NewMode, int *PSPCodeResolution, int *HwImgDimX, int *HwImgDimY);
                                #endif
                                ...
                                /// ----------------------------------------------------------
                                 ...
                                 #include <HAL_CFW_PSP/$$_HAL_NetworkWrapper.h>
                                ...
                                int  ndHAL_PseudoPspSdkLoadStartModule(char *path, int attrib);
                                ...
                                #ifdef HAL_I_NEED_TO_DEFINE_ALL_PROTOTYPES
                                   void INTERNAL_TerminateAudioDriver ();
                                #endif
                                ...
                                #include <HAL_CFW_PSP\$$_HAL_SetKrnlExtender.h>  
