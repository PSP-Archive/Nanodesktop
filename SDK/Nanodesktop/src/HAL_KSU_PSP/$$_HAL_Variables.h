/*  
    ...
    ---------------------------------------------------------------------------
    FILE SPECIALE DI DEFINIZIONE DELLE VARIABILI PER HAL (PSP KSU mode)
    ---------------------------------------------------------------------------
      ...
      // Impedirà che questo file possa essere incluso due volte nella compilazione
       ...
       #define NDEXTERN extern
                                ...
                                */
                                ...
                                /*
                                   -----------------------------------------------------------------------------------
                                   VARIABILI PER GESTORE KSU
                                   -----------------------------------------------------------------------------------
                                */
                                  
                                   #define KSU_SLEEP_PRIORITY 80
                                   
                                   NDEXTERN int  ndUserMainThreadID;
                                   NDEXTERN char ndServicesLoopExit;
                      
                                   NDEXTERN int  ndKSUThreadID, ndKSUStdPriority;
                                  ...
                                  */
                                  ...
                                  /*   ---------------------------------------------------------
                                    ...
                                    */
                                    ...
                                    NDEXTERN struct SceKernelLoadExecParam ndLoadExecStdStruct;
                                    
                                    NDEXTERN const char   ndTransExecutionFileName [128];
                                    
                                    #ifdef HAL_I_NEED_TO_DECLARE_VARIABLES   
                                         char ndTransExecutionRequested = 0;
                                    #else
                                         NDEXTERN char ndTransExecutionRequested;
                                    #endif
