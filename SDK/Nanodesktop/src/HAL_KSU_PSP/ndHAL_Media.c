/*  
    ...
    ---------------------------------------------------------------------------
    HAL: FUNZIONI DECODIFICA FORMATI AUDIO (PSP KSU mode)
    ---------------------------------------------------------------------------
*/
...
void ndHAL_InitMediaService (void)
{
     ...
     {
         uid = pspSdkLoadStartModule("flash0:/kd/me_for_vsh.prx", PSP_MEMORY_PARTITION_KERNEL);
         pspSdkFixupImports (uid);
         
         uid = pspSdkLoadStartModule("flash0:/kd/audiocodec.prx", PSP_MEMORY_PARTITION_KERNEL);  
         pspSdkFixupImports (uid);                             
     }
}
