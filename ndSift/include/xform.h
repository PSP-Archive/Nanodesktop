...
*/
typedef xdouble (*ransac_err_fn)( CvPoint2D64f pt, CvPoint2D64f mpt, CvMat* T );
...
extern CvMat* ransac_xform( struct feature* features, int n, int mtype,
			    ...
			    xdouble p_badxform, ransac_err_fn err_fn,
			    xdouble err_tol, struct feature*** inliers,
			    int* n_in );
...
*/
extern xdouble homog_xfer_err( CvPoint2D64f pt, CvPoint2D64f mpt, CvMat* H );
