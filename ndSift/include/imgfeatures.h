...
struct feature
{
  xdouble x;                      /**< x coord */
  xdouble y;                      /**< y coord */
  xdouble a;                      /**< Oxford-type affine region parameter */
  xdouble b;                      /**< Oxford-type affine region parameter */
  xdouble c;                      /**< Oxford-type affine region parameter */
  xdouble scl;                    /**< scale of a Lowe-style feature */
  xdouble ori;                    /**< orientation of a Lowe-style feature */
  int d;                         /**< descriptor length */
  xdouble descr[FEATURE_MAX_D];   /**< descriptor */
...
/**
   ...
   @return Returns the squared Euclidian distance between the descriptors of
     \a f1 and \a f2.
*/
extern xdouble descr_dist_sq( struct feature* f1, struct feature* f2 );
