...
xdouble sigma = SIFT_SIGMA;
xdouble contr_thr = SIFT_CONTR_THR;
...
/*
  sift_arg_parse() parses the command line arguments, setting appropriate globals.
  
  argc and argv should be passed directly from the command line
*/
void sift_arg_parse( int argc, char** argv )
{
