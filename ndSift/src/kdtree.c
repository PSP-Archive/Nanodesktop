...
xdouble median_select( xdouble*, int );
xdouble rank_select( xdouble*, int, int );
void insertion_sort( xdouble*, int );
int partition_array( xdouble*, int, xdouble );
...
void assign_part_key( struct kd_node* kd_node )
{
  ...
  xdouble kv, x, mean, var, var_max = 0;
  xdouble* tmp;
  int d, n, i, j, ki = 0;
...
*/
xdouble median_select( xdouble* array, int n )
{
...
*/
xdouble rank_select( xdouble* array, int n, int r )
{
  xdouble* tmp, med;
  ...
  tmp = calloc( gr_tot, sizeof( xdouble ) );
...
*/
void insertion_sort( xdouble* array, int n )
{
  xdouble k;
  int i, j;
...
*/
int partition_array( xdouble* array, int n, xdouble pivot )
{
  xdouble tmp;
  int p, i, j;
