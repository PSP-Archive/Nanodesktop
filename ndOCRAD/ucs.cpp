...
int UCS::base_letter( const int code ) throw()
  {
  switch( code )
    {
    case CAGRAVE:
...
int UCS::compose( const int letter, const int accent ) throw()
  {
  switch( letter )
    {
...
bool UCS::isalnum( const int code ) throw()
  {
  return ( UCS::isalpha( code ) || UCS::isdigit( code ) );
  }


bool UCS::isalpha( const int code ) throw()
  {
  return ( ( code < 128 && std::isalpha( code ) ) || base_letter( code ) );
  }


bool UCS::isdigit( const int code ) throw()
  {
  return ( code <= '9' && code >= '0' );
  }


bool UCS::islower( const int code ) throw()
  {
...
bool UCS::islower_ambiguous( const int code ) throw()
  {
...
bool UCS::islower_small( const int code ) throw()
  {
...
bool UCS::islower_small_ambiguous( const int code ) throw()
  {
  if( code >= 128 || !std::islower( code ) ) return false;
  switch( code )
    {
...
bool UCS::isspace( const int code ) throw()
  {
  return ( code < 128 && std::isspace( code ) );
  }


bool UCS::isupper( const int code ) throw()
  {
...
char UCS::map_to_byte( const int code ) throw()
  {
  if( code < 0 ) return 0;
...
char * UCS::ucs_to_utf8( const int code ) throw()
  {
  static char s[7];
...
int UCS::to_nearest_digit( const int code ) throw()
  {
  switch( code )
    {
    case 'O':
...
int UCS::to_nearest_letter( const int code ) throw()
  {
  switch( code )
    {
    case '0': return 'O';
...
int UCS::toupper( const int code ) throw()
  {
