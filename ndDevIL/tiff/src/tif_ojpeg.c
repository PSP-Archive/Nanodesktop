...
#   endif
    ...
    utiff_int32 is_WANG,    /* <=> Wang Imaging for Microsoft Windows output file? */
    ...
    utiff_int16 jpegproc;
    utiff_int32 jpegifoffset;
    utiff_int32 jpegifbytecount;
    utiff_int32 jpegrestartinterval;
    void* jpeglosslesspredictors;
    utiff_int16 jpeglosslesspredictors_length;
    void* jpegpointtransform;
    utiff_int32 jpegpointtransform_length;
    void* jpegqtables;
    utiff_int32 jpegqtables_length;
    void* jpegdctables;
    utiff_int32 jpegdctables_length;
    void* jpegactables;
    utiff_int32 jpegactables_length;
...
OJPEGSetupEncode(register TIFF *tif)
  { static const char module[]={"OJPEGSetupEncode"};
    utiff_int32 segment_height, segment_width;
...
#   define td (&tif->tif_dir)
    toff_t tiffoff=0;
    utiff_int32 bufoff=0;
    utiff_int32 code_count=0;
    int i2=0;
    int k2=0;
    ...
    v32 = va_arg(ap,utiff_int32); /* No. of values in this TIFF record */
...
#             endif /* C_LOSSLESS_SUPPORTED */
     ...
     */
        case TIFFTAG_JPEGLOSSLESSPREDICTORS:
           if (v32)
             {
               sp->cinfo.d.Ss = *va_arg(ap,utiff_int16 *);
		    ...
		    _TIFFmalloc(sp->jpeglosslesspredictors_length
               ...
               for(i2=0;i2<sp->jpeglosslesspredictors_length;i2++){
                ((utiff_int16*)sp->jpeglosslesspredictors)[i2] =
			((utiff_int16*)sp->cinfo.d.Ss)[i2];
               }
               sp->jpeglosslesspredictors_length*=sizeof(utiff_int16);
               break;
             };
           return v32;
     ...
     */
        case TIFFTAG_JPEGPOINTTRANSFORM    :
           if (v32)
             {
               sp->cinfo.d.Al = *va_arg(ap,utiff_int16 *);
               sp->jpegpointtransform =
		    _TIFFmalloc(sp->jpegpointtransform_length*sizeof(utiff_int16));
               if(sp->jpegpointtransform==NULL){return(0);}
               for(i2=0;i2<sp->jpegpointtransform_length;i2++) {
                ((utiff_int16*)sp->jpegpointtransform)[i2] =
			((utiff_int16*)sp->cinfo.d.Al)[i2];
               }
               sp->jpegpointtransform_length*=sizeof(utiff_int16);
               break;
             }
           return v32;
...
OJPEGVGetField(register TIFF *tif,ttag_t tag,va_list ap)
  { register OJPEGState *sp = OJState(tif);
     ...
     */
        case TIFFTAG_JPEGTABLES            :
          if (sp->jpegtables_length) /* we have "new"-style JPEG tables */
            {
              *va_arg(ap,utiff_int32 *) = sp->jpegtables_length;
     ...
     */
        case TIFFTAG_JPEGCOLORMODE         :
          *va_arg(ap,utiff_int32 *) = sp->jpegcolormode;
          return 1;
     ...
     */
        case TIFFTAG_JPEGPROC              :
		*va_arg(ap, utiff_int16*)=sp->jpegproc;
		return(1);
		break;
        case TIFFTAG_JPEGIFOFFSET          :
		*va_arg(ap, utiff_int32*)=sp->jpegifoffset;
		return(1);
		break;
        case TIFFTAG_JPEGIFBYTECOUNT       :
		*va_arg(ap, utiff_int32*)=sp->jpegifbytecount;
		return(1);
		break;
        case TIFFTAG_JPEGRESTARTINTERVAL   :
		*va_arg(ap, utiff_int32*)=sp->jpegrestartinterval;
		return(1);
		break;
        case TIFFTAG_JPEGLOSSLESSPREDICTORS:
                *va_arg(ap, utiff_int32*)=sp->jpeglosslesspredictors_length;
                *va_arg(ap, void**)=sp->jpeglosslesspredictors;
                return(1);
                break;
        case TIFFTAG_JPEGPOINTTRANSFORM    :
                *va_arg(ap, utiff_int32*)=sp->jpegpointtransform_length;
                *va_arg(ap, void**)=sp->jpegpointtransform;
                return(1);
                break;
        case TIFFTAG_JPEGQTABLES           :
                *va_arg(ap, utiff_int32*)=sp->jpegqtables_length;
                *va_arg(ap, void**)=sp->jpegqtables;
                return(1);
                break;
        case TIFFTAG_JPEGDCTABLES          :
                *va_arg(ap, utiff_int32*)=sp->jpegdctables_length;
                *va_arg(ap, void**)=sp->jpegdctables;
                return(1);
                break;
        case TIFFTAG_JPEGACTABLES          : 
                *va_arg(ap, utiff_int32*)=sp->jpegactables_length;
...
static utiff_int32
OJPEGDefaultStripSize(register TIFF *tif,register utiff_int32 s)
  { register OJPEGState *sp = OJState(tif);
#   define td (&tif->tif_dir)
...
static void
OJPEGDefaultTileSize(register TIFF *tif,register utiff_int32 *tw,register utiff_int32 *th)
  { register OJPEGState *sp = OJState(tif);
 ...
 */
    if (tif->tif_header.tiff_diroff > sizeof tif->tif_header)
      ...
      { utiff_int32 maxoffset = tif->tif_size;
