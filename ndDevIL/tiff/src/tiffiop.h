...
typedef	int (*TIFFSeekMethod)(TIFF*, utiff_int32);
typedef	void (*TIFFPostMethod)(TIFF*, tidata_t, tsize_t);
typedef	utiff_int32 (*TIFFStripMethod)(TIFF*, utiff_int32);
typedef	void (*TIFFTileMethod)(TIFF*, utiff_int32*, utiff_int32*);

struct tiff {
	char*		tif_name;	/* name of open file */
	int		tif_fd;		/* open file descriptor */
	int		tif_mode;	/* open mode (O_*) */
	utiff_int32		tif_flags;
...
#define	TIFF_HEADERONLY		0x10000	/* read header only, do not process */
	...
	utiff_int16		tif_dirnumber;  /* number of already seen directories */
	TIFFDirectory	tif_dir;	/* internal rep of current directory */
	TIFFHeader	tif_header;	/* file's header block */
	const int*	tif_typeshift;	/* data type shift counts */
	const long*	tif_typemask;	/* data type masks */
	utiff_int32		tif_row;	/* current scanline */
	tdir_t		tif_curdir;	/* current directory (index) */
	tstrip_t	tif_curstrip;	/* current strip for read/write */
	toff_t		tif_curoff;	/* current offset for read/write */
	toff_t		tif_dataoff;	/* current offset for writing dir */
/* SubIFD support */
	utiff_int16		tif_nsubifd;	/* remaining subifds to write */
	toff_t		tif_subifdoff;	/* offset for patching SubIFD link */
/* tiling support */
	utiff_int32 		tif_col;	/* current column (offset by row too) */
...
/* NB: the utiff_int32 casts are to silence certain ANSI-C compilers */
#define TIFFhowmany(x, y) ((((utiff_int32)(x))+(((utiff_int32)(y))-1))/((utiff_int32)(y)))
#define TIFFhowmany8(x) (((x)&0x07)?((utiff_int32)(x)>>3)+1:(utiff_int32)(x)>>3)
...
extern	int _TIFFNoSeek(TIFF*, utiff_int32);
...
extern	utiff_int32 _TIFFDefaultStripSize(TIFF*, utiff_int32);
extern	void _TIFFDefaultTileSize(TIFF*, utiff_int32*, utiff_int32*);
extern	int _TIFFDataSize(TIFFDataType);

extern	void _TIFFsetByteArray(void**, void*, utiff_int32);
extern	void _TIFFsetString(char**, char*);
extern	void _TIFFsetShortArray(utiff_int16**, utiff_int16*, utiff_int32);
extern	void _TIFFsetLongArray(utiff_int32**, utiff_int32*, utiff_int32);
extern	void _TIFFsetFloatArray(float**, float*, utiff_int32);
extern	void _TIFFsetDoubleArray(double**, double*, utiff_int32);
