...
void
TIFFSwabArrayOfShort(utiff_int16* wp, register unsigned long n)
{
...
void
TIFFSwabArrayOfLong(register utiff_int32* lp, register unsigned long n)
{
	register unsigned char *cp;
	register unsigned char t;
...
{
        register utiff_int32* lp = (utiff_int32*) dp;
        utiff_int32 t;
