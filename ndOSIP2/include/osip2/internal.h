...
/* HAVE_PTHREAD_H is not used any more! I keep it for a while... */
    ...
    !defined(HAVE_PTHREAD) && !defined(HAVE_PTHREAD_H) && !defined(HAVE_PTH_PTHREAD_H) && !defined(PSP)
...
#if (defined(WIN32) || defined(_WIN32_WCE) || defined(PSP)) && !defined(HAVE_PTHREAD_WIN32)
typedef struct osip_cond
{
